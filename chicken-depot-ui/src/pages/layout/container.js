      ...
      <div className="layout-container">
        ...
        <Jumbotron>
          ...
          <p className="lead">This project was done as a final project for the bootcamp I attended at Helio Training in
            ...
            The main purpose of this project is to show the ability to make a web application using React.js with full
          ...
          <ul>
            ...
            <li>The "Add To Cart" button will add that product to the cart and you can see the number of items in the
              cart change as you add them.
            </li>
            <li>***WARNING*** The "Delete" button deletes the product from the database and it has to be added back in
              on the "New Products" page. If you want to use it please delete one of the cards at the bottom that say
              "Delete Me".
            </li>
            <li>The Update button is unique because it takes the product ID# and routes you to the "Update Product" page
              and auto loads the form to make the update simple. Go ahead and update any card you like, and you can
              change any input field to what ever you want and press the "Update Product" button, you will then be
              rerouted back to the "Products" page where you can see the product card has been updated with the new
              information.
            </li>
          </ul>
          ...
          <ul>
            <li>The "New Products" page is a very simple form. Go ahead and fill in the input fields and then press the
              ...
              to not reroute back to the "Products" page so that multiple items could be added as quickly and easily as
              possible.
            </li>
            <li>I also added a "Clear" button to clear all of the input fields so they don't have to be deleted
